...
void DotSceneLoader::parseDotScene(const std::string &SceneName, const std::string &groupName, Ogre::SceneManager *yourSceneMgr, Ogre::SceneNode *pAttachNode, const std::string &sPrependNode)
{/*
